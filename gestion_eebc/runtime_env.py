...
def normalize_runtime_environment() -> None:
    ...
    A deployment may expose CELERY_BROKER_URL for a Redis-compatible instance
    without exposing REDIS_URL. Reusing that URL preserves the production
    requirement for a shared cache instead of falling back to process-local
    memory.
    """
