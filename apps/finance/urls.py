...
urlpatterns = [
    ...
    path('transactions/<int:pk>/validate/', sv.transaction_validate, name='transaction_validate'),
    ...
    path('budgets/<int:budget_id>/approve-detailed/', sv.budget_approve_detailed, name='budget_approve_detailed'),
    path('budgets/<int:budget_id>/submit/', sv.budget_submit, name='budget_submit'),
    ...
    path('receipts/<int:pk>/process-ocr/', sv.receipt_process_ocr, name='receipt_process_ocr'),
    path('receipts/batch-retry-ocr/', sv.batch_retry_ocr, name='batch_retry_ocr'),
