...
urlpatterns = [
    ...
    path('upload/', sv.document_upload, name='upload'),
    path('categories/', views.category_list, name='categories'),
    path('stats/', views.document_stats, name='stats'),
    path('shared/<uuid:token>/', sv.shared_access, name='shared_access'),
    ...
    path('<int:pk>/stream/', sv.document_stream, name='stream'),
    path('<int:pk>/preview/', sv.document_preview, name='preview'),
